...
condition of the Russian road network.
...
(STC).  A central system will be informed of the location and state of
every truck in the fleet, permitting decision making systems to have
complete knowledge of the state of the company assets.
...
\begin{itemize}
  ...
  \item The developers who have to implement the entire mess.
...
The architecture of the STS is still very early in its development.
Not even all requirements have been collected yet.
