...
\begin{center}
  \begin{tabular}[h!]{| l | l | l | p{8 cm} |}
    ...
    \hline
    2 & 2012-09-10 & TRH, SHB and JTM & added 1.1, 1.2, 1.3 and 5.1 \\
    \hline
    3 & 2012-09-17 & SHB and JTM & added chapter 3\\
    \hline
    4 & 2012-09-24 & TRH, SHB and JTM & added chapter 4 and 5.2\\
   \hline
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}[h!]{| >{\columncolor{gray}}p{0.28\textwidth} | p{0.65\textwidth} |}
    ...
    \hline
    Responsibilities & send truck positions via SMS to the server and get confirmation from the data receiver\\
    \hline
...
\begin{center}
  \begin{tabular}[h!]{| >{\columncolor{gray}}p{0.28\textwidth} | p{0.65\textwidth} |}
    ...
    \hline
    Responsibilities & Gather the positions from all the trucks and send confirmations to the trucks, when the data is received\\
    \hline
